...
class MappedStream extends Transform {
   ...
   * @param {boolean} [abortOnError=] True if error in mapping should emit error, false otherwise
   */
  constructor (mapper, inputObjectMode = true, outputObjectMode = true, abortOnError = false) {
