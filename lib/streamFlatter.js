...
class StreamFlatter extends Transform {
   ...
   */
  constructor (jsonSchema, collectionName, includeMetadata = false, pathSeparator = undefined, generatedFieldPrefix = undefined, placeholder = undefined) {
    super({
      objectMode: true
    })

    this._includeMetadata = includeMetadata
    this._dataFlatter = new DataFlatter(jsonSchema, collectionName, pathSeparator, generatedFieldPrefix, placeholder)
  }
