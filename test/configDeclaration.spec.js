...
describe('ConfigDeclaration', () => {
  describe('#constructor()', () => {
    ...
    it('clones instance', () => {
      const that = new ConfigDeclaration()
        .parameter('param', {})
      new ConfigDeclaration(that)
  ...
  describe('#include()', () => {
    ...
    it('throws on duplicate parameter', () => {
      ...
      (() => new ConfigDeclaration()
          .parameter('param', {})
          .include(that))
        .should.throw(/parameter already declared/)
    })

    it('overwrites duplicate parameter', () => {
      const that = new ConfigDeclaration()
        .parameter('param', { description: 'that' })
      new ConfigDeclaration()
  ...
  describe('#conflicts()', () => {
    it('throws on invalid number of arguments', () => {
      (() => new ConfigDeclaration()
          .parameter('a', {})
          .conflicts('a'))
        .should.throw(/At least two conflicting names must be specified/)
    })
    ...
    it('throws on undefined parameters', () => {
      (() => new ConfigDeclaration()
          .parameter('a', {})
          .conflicts('a', 'b'))
        .should.throw(/parameter is not declared/)
    })
